...
void AShooterPlayerController::SetupInputComponent()
{
	...
	if (IsLocalPlayerController())
	{
		...
		{
			UE_LOG(LogModuleAndPlugin, Error, TEXT("Could not spawn bullet counter widget."));
		}
	}
}
...
void AShooterPlayerController::OnPawnDestroyed(AActor* DestroyedActor)
{
	...
	if (TeamByte < TeamTags.Num())
	{
		...
		UGameplayStatics::GetAllActorsOfClassWithTag(GetWorld(), APlayerStart::StaticClass(), TeamTags[TeamByte],
		                                             ActorList);
